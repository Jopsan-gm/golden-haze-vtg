...
const Hero = () => {
    return (
        <section className="relative h-[85vh] flex items-center justify-center bg-slate-950 overflow-hidden">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-b from-slate-950/80 via-slate-900/40 to-transparent" />
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl">
                <motion.span
                    ...
                    className="text-white font-sans uppercase tracking-[0.3em] text-sm mb-2 block drop-shadow-md"
                >
                ...
                <motion.p
                    ...
                    className="text-gray-200 text-lg md:text-xl font-sans max-w-2xl mx-auto mb-6 leading-relaxed drop-shadow-lg"
                >
